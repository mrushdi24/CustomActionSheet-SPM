...
public class CustomActionSheet: UIView {
    ...
    @available(iOS 13.0, *)
    public init(actions: [ActionSheet],title: String,cancelTitle: String,style: ActionSheetStyle, onSelect: @escaping (Int) -> Void) {
        super.init(frame: UIScreen.main.bounds)
        self.onSelect = onSelect
        self.style = style
        setupUI(actions: actions, title: title, cancelTitle: cancelTitle)
    }
    ...
    @available(iOS 13.0, *)
    private func setupUI(actions: [ActionSheet], title: String, cancelTitle: String) {
        ...
        configureCancelButton(title: cancelTitle)
    ...
    private func configureCancelButton(title: String){
